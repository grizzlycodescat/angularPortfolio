...
export class WorkComponent implements OnInit {
  ...
  workExp =  
  {
    ...
    ending: {
      message: "If you've found my experiences interesting, please feel free to download my resume, or find me on LinkedIn by clicking the links below. Home is on the right!",
    }
  }
